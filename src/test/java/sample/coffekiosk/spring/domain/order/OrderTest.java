package sample.coffekiosk.spring.domain.order;
...
import static sample.coffekiosk.spring.domain.product.ProductSellingStatus.SELLING;
...
class OrderTest {
    ...
    @DisplayName("주문 생성 시 상품 주문상태는 INIT이다.")
    @Test
    void init() {
        //given
        List<Product> products = List.of(
